...
<nav class="wrapper">
  <div class="wrapper-inside">
    ...
    >
    <div class="menu-last">
      <button class="mainbtn">Newsletter</button>
    </div>
  </div>
</nav>
<div class="hidden w-full" id="navbar-default">
  ...
  >
    <li>
      <a
        href="/"
        class="block py-2 px-3 bg-amber-700 rounded"
    ...
    <li>
      <a
        href="/media"
        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100">Media</a
      >
    </li>
    <li>
      <a
        href="/team"
        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100">Team</a
      >
    </li>
    <li>
      <a
